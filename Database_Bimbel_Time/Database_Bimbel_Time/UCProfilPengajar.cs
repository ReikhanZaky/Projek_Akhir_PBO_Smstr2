...
{
    public partial class UCProfilPengajar : UserControl
    {
        private User user;

        public UCProfilPengajar(User u)
        {
            InitializeComponent();
            this.user = u;
        ...
        private void UCProfilPengajar_Load(object sender, EventArgs e)
        {
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            using (var conn = new NpgsqlConnection(connString))
            {
                ...
                string updatePengajar = "UPDATE Murid SET Alamat = @alamat WHERE UserID = @id";
                ...
                using (var cmd2 = new NpgsqlCommand(updatePengajar, conn))
                {
